...
#EDIT THE FOLLOWING:
$toAddress = "deja.taylor@gmail.com";  //place your/your client's email address here
$toName = "Deja Taylor"; //place your client's name here
$website = "https://michaelrodgers.azurewebsites.net/";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>
		<label>
			Name:<br /><input type="text" name="Name" required="required" placeholder="Name (required)" title="Name is required" tabindex="10" size="44" />
		</label>
	</div>
	<div>	
		<label>
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="Booking A Performance" tabindex="40" /> Booking A Performance <br />
			<input type="checkbox" name="Interested_In[]" value="Artistic Collaboration" /> Artistic Collaboration <br />
			<input type="checkbox" name="Interested_In[]" value="Featured Sponsorship In Videos" /> Featured Sponsorship In Videos <br />
